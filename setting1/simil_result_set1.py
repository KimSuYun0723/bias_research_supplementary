...
print("\n=== SETTING 2: BERT VS JMBMT (POOLED OUTPUT) ===")
bert_csv_path = "/home/nlpgpu7/ellt/suyun/bias_research/setting2/bert_pooled_set2.csv"
our_model_csv_path = "/home/nlpgpu7/ellt/suyun/bias_research/setting2/jmbmt_pooled_set2.csv"
bert_df = pd.read_csv(bert_csv_path)
our_model_df = pd.read_csv(our_model_csv_path)
