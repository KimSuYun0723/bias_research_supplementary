...
def get_hidden_state_our_model(tokenizer, model, text, device="cpu"):
    ...
    # Forward pass
    with torch.no_grad():
        last_hidden_state, _ = model.compute_logits_and_hidden_states(inputs["input_ids"])
...
if __name__ == "__main__":
    ...
    # 결과 저장
    output_path = "/home/nlpgpu7/ellt/suyun/bias_research/setting2/jmbmt/jmbmt_hs_set2.csv"
