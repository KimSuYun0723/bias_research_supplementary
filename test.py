...
final_df_path = "/home/nlpgpu7/ellt/suyun/bias_research/bbq_data/preprocessed_bbq/final_combined.csv"
final_df = pd.read_csv(final_df_path)

# JMBMT가 가장 잘한 것 저장
"""
# 1. jmbmt_good인 데이터만 필터링(이미 jmbmt는 disambig>ambig, bert는 ambig>disambig)
jmbmt_good_df = final_df[final_df['label'] == 'jmbmt_good']
print(f"1. jmbmt_good인 데이터만 필터링: {len(jmbmt_good_df)}")

# 2. JMBMT의 ambig - disambig 차이 VS bert의 ambig - disambig 차이
...
jmbmt_good_df = jmbmt_good_df[(jmbmt_good_df['bert_ambig_simil'] - jmbmt_good_df['bert_disambig_simil']) >= 0.05]
...
# 6. 결과를 CSV로 저장
filtered_csv_path = "/home/nlpgpu7/ellt/suyun/bias_research/bbq_data/preprocessed_bbq/filtered_jmbmt_good.csv"
...
"""# 6. 결과를 CSV로 저장
label_averages_csv_path = "/home/nlpgpu7/ellt/suyun/bias_research/bbq_data/preprocessed_bbq/label_averages.csv"
